package com.taxibookingdriver.Amazon;
...
public class Utils {
    ...
    private static CognitoCachingCredentialsProvider getCredProvider(Context context) {
        ...
        if (sCredProvider == null) {
            ...
            sCredProvider = new CognitoCachingCredentialsProvider(
                    ...
                    Constant.POOL_ID,
                    Regions.fromName(Constant.REGION));
        }
    ...
    public static AmazonS3Client getS3Client(Context context) {
        master = new Pref_Master(context);
        if (sS3Client == null) {
            String key = Constant.ACCESSKEY;
            String secret = Constant.SECRETKEY;
            credentials = new BasicAWSCredentials(key, secret);
            sS3Client = new AmazonS3Client(credentials);
            sS3Client.setRegion(Region.getRegion(Regions.fromName(Constant.REGION)));
        }
        return sS3Client;
    }
